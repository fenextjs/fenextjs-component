export default {
    ...
    props: [
        ...
        },
        {
            ...
            default: "undefined",
            description:
                "El contenido que se mostrará dentro del componente Copy.",
        },
        {
            id: "onClickForCopy",
            type: "function",
            ...
            default: "undefined",
            description:
                "Función personalizada que se ejecuta después de copiar el texto.",
        },
        {
            id: "notification",
            ...
            description:
                "Configuración de la notificación que se muestra al copiar el texto.",
        },
        {
            id: "className",
            type: "string",
