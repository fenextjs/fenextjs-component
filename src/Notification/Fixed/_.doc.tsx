export default {
    ...
    name: "Notification",
    description: "El componente Notification permite mostrar mensajes de notificación personalizados, con distintos tipos de resultados y estilos para cada tipo.",
    props: [
        {
            id: "className",
            type: "string",
        ...
        },
        {
            ...
            description: "Tipo de notificación, que define el estilo y el propósito del mensaje.",
        },
        {
            id: "children",
            type: "ReactNode",
            require: false,
            default: "undefined",
            description: "Contenido o mensaje que se mostrará dentro de la notificación.",
        }
    ],
    useExample: [
        {
