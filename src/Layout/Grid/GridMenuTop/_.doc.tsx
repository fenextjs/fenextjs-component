export default {
    ...
    description: "El componente LayoutGridMenuTop es un diseño de cuadrícula que incluye un menú superior y permite gestionar una barra de progreso de página, mostrar alertas personalizadas y un indicador de carga.",
    props: [
        {
            id: "useAlertHook",
            type: "boolean",
        ...
        },
        {
            ...
            require: false,
            default: "true",
            description: "Indica si se debe mostrar la barra de progreso de página.",
        },
        {
            id: "className",
            type: "string",
    ...
    extras: [
        {
            ...
            description: "Si 'useAlertHook' está habilitado, el componente de alerta (AlertHook) se renderiza con las propiedades proporcionadas en 'alertHookProps'.",
        }
    ],
    useExample: [
        {
