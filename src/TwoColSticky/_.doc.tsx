export default {
    ...
    name: "TwoColSticky",
    description: "El componente TwoColSticky crea una disposición de dos columnas, donde una columna es fija (sticky) y la otra es desplazable. Se puede personalizar la posición de la columna sticky, y las clases CSS para cada sección.",
    props: [
        {
            id: "className",
            type: "string",
        ...
        },
        {
            ...
            require: false,
            default: "''",
            description: "Clase CSS para la columna desplazable del componente.",
        },
        {
