export default {
    ...
    name: "Tab",
    description: "El componente Tab permite la creación de pestañas con contenidos asociados, personalizables en clases CSS y comportamiento.",
    props: [
        {
            id: "className",
            type: "string",
        ...
        },
        {
            ...
            require: false,
            default: "\"\"",
            description: "Clase CSS para el contenedor del encabezado del contenido de las pestañas.",
        },
        {
            id: "classNameHead",
            type: "string",
        ...
        },
        {
            ...
            require: false,
            default: "\"\"",
            description: "Clase CSS para cada elemento del encabezado de la pestaña.",
        },
        {
            ...
            require: false,
            default: "\"\"",
            description: "Clase CSS para el elemento activo del encabezado de la pestaña.",
        },
        {
            id: "classNameBody",
            type: "string",
            require: false,
            default: "\"\"",
            description: "Clase CSS para el contenedor del cuerpo de las pestañas.",
        },
        {
            ...
            require: false,
            default: "\"\"",
            description: "Clase CSS para cada elemento del cuerpo de la pestaña.",
        },
        {
            id: "items",
            type: "TabItemProps[]",
            require: false,
            default: "[]",
            description: "Lista de objetos que representan las pestañas con encabezado y cuerpo.",
        },
        {
            id: "defaultTab",
            type: "number",
        ...
        },
        {
            ...
            require: false,
            default: "false",
            description: "Determina si las pestañas deben estar en modo de desplazamiento al seleccionar.",
        },
        {
            ...
            require: false,
            default: "true",
            description: "Oculta el encabezado de las pestañas si solo hay una pestaña presente.",
        },
        {
            id: "useCount",
            type: "boolean",
            require: false,
            default: "false",
            description: "Permite mostrar un contador de elementos en el encabezado de la pestaña.",
        }
    ],
    useExample: [
        {
