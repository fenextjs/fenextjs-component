    ...
    props: [
        {
            ...
            default: "2",
            description:
                "Número de columnas en las que se organizarán los elementos. Puede ser un valor numérico o una cadena.",
        },
        {
            id: "breakInside",
            type: "boolean",
            ...
            default: "true",
            description:
                "Indica si se debe aplicar la propiedad 'break-inside' para evitar la ruptura interna de los elementos dentro de las columnas.",
        },
        {
            id: "children",
            type: "ReactNode",
            ...
            default: "undefined",
            description:
                "Contenido o elementos que se mostrarán dentro de las columnas.",
        },
        {
            id: "className",
            type: "string",
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el contenedor de las columnas.",
        },
    ],
    useExample: [
        {
