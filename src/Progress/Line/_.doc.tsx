    ...
    props: [
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el contenedor del componente ProgressLine.",
        },
        {
            id: "p",
            type: "number",
            ...
            default: "N/A",
            description:
                "Valor de progreso representado en la barra, como un número entre 0 y 100.",
        },
        {
            id: "showP",
            type: "boolean",
            ...
            default: "true",
            description:
                "Indica si el valor numérico del progreso (`p`) se muestra junto a la barra.",
        },
    ],
    useExample: [
        {
