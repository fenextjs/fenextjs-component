    ...
    props: [
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el contenedor del interruptor.",
        },
        {
            id: "classNameCicle",
            type: "string",
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el círculo dentro del interruptor.",
        },
        {
        ...
        },
        {
            ...
            default: "''",
            description:
                "Nombre del interruptor que se usará como atributo del input.",
        },
        {
            id: "onChange",
            type: "(e: boolean) => void",
            ...
            default: "undefined",
            description:
                "Función que se ejecuta cuando el estado del interruptor cambia. Recibe un valor booleano que indica si está activado o desactivado.",
        },
        {
            id: "defaultValue",
            type: "boolean",
            ...
            default: "false",
            description:
                "Valor inicial del interruptor cuando se renderiza por primera vez.",
        },
        {
            id: "value",
            type: "boolean",
            ...
            default: "undefined",
            description:
                "Valor actual del interruptor, puede ser controlado externamente.",
        },
        {
            id: "disabled",
            type: "boolean",
        ...
        },
        {
            ...
            default: "async () => {}",
            description:
                "Función para validar el estado del interruptor cuando se cambia. Puede devolver una promesa para manejar validaciones asíncronas.",
        },
    ],
    useExample: [
        {
