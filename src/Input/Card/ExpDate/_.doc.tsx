    ...
    props: [
        {
            ...
            default: "{}",
            description:
                "Valor predeterminado del componente, que incluye el mes y el año de expiración de la tarjeta.",
        },
        {
            id: "value",
            type: "InputCardExpDateDataProps",
            ...
            default: "{}",
            description:
                "Valor controlado del componente, que debe incluir el mes y el año de expiración.",
        },
        {
            id: "onChange",
            ...
            default: "undefined",
            description:
                "Función que se ejecuta cuando los datos del componente cambian, proporcionando el mes y el año como objeto.",
        },
        {
            id: "maxExpDateLength",
            type: "number",
            ...
            default: 4,
            description:
                "Longitud máxima permitida para la entrada de la fecha de expiración. Se establece como 4 para MMYY.",
        },
        {
            id: "placeholder",
            type: "string",
