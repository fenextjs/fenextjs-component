    ...
    props: [
        {
            ...
            default: "'XXX'",
            description:
                "Texto que se muestra como marcador de posición en el campo de entrada.",
        },
        {
            id: "disabled",
            type: "boolean",
        ...
        },
        {
            ...
            default: 4,
            description:
                "Longitud máxima permitida para la entrada, en este caso 4 caracteres. Se establece directamente en el componente.",
        },
        {
            id: "regExpReplace",
            type: "string",
            ...
            default: "''",
            description:
                "Cadena utilizada para reemplazar los valores no deseados. Se establece directamente en el componente.",
        },
        {
            id: "regExp",
            type: "RegExp",
            ...
            default: "/[^0-9]/g",
            description:
                "Expresión regular que se utiliza para validar la entrada, permitiendo solo números. Se establece directamente en el componente.",
        },
        {
            id: "inputMode",
            type: "string",
            ...
            default: "'numeric'",
            description:
                "Modo de entrada para facilitar el ingreso de datos numéricos en dispositivos móviles. Se establece directamente en el componente.",
        },
        {
            id: "type",
            type: "string",
            ...
            default: "'number'",
            description:
                "Tipo de entrada del campo, que se establece como número. Se establece directamente en el componente.",
        },
    ],
    useExample: [
        {
