export default {
    ...
    description: "El componente InputSelectCountryMultiple permite seleccionar múltiples países de una lista de opciones, con posibilidad de personalización adicional a través de las propiedades del componente.",
    props: [
        {
            id: "...props",
            type: "InputSelectMultipleTProps<CountryProps>",
            require: false,
            description: "Propiedades adicionales que extienden de InputSelectMultipleTProps, como eventos o configuraciones del componente.",
        }
    ],
    useExample: [
        {
