export default {
    ...
    description: "El componente InputUnitVolumen permite al usuario seleccionar y gestionar unidades de volumen, ofreciendo opciones predeterminadas y personalizadas. Está basado en `InputUnitBase` y extiende su funcionalidad con opciones específicas de volumen.",
    props: [
        {
            id: "defaultValue",
        ...
        },
        {
            ...
            description: "Opciones de unidades de volumen disponibles para seleccionar.",
        },
        {
            id: "className",
            type: "string",
