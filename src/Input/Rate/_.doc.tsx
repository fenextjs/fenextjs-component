    ...
    props: [
        {
            ...
            default: "undefined",
            description:
                "Valor actual de la calificación. Se espera un número entre 0 y 5.",
        },
        {
            id: "defaultValue",
            type: "number",
            ...
            default: "0",
            description:
                "Valor predeterminado de la calificación cuando no se proporciona 'value'.",
        },
        {
            id: "className",
            type: "string",
        ...
        },
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el contenedor de las estrellas.",
        },
        {
            id: "classNameStar",
            type: "string",
        ...
        },
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar las estrellas activas (calificadas).",
        },
        {
            id: "classNameNumber",
            type: "string",
            ...
            default: "''",
            description:
                "Clase CSS para personalizar la visualización del número de calificación.",
        },
        {
            id: "onChange",
            ...
            default: "undefined",
            description:
                "Función que se ejecuta cuando cambia la calificación seleccionada.",
        },
    ],
    useExample: [
        {
