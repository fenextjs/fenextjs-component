    ...
    props: [
        {
            ...
            default: "undefined",
            description:
                "El contenido que se mostrará cuando no esté en estado de carga.",
        },
        {
            id: "componentLoader",
            type: "ReactNode",
            ...
            description:
                "Componente que se muestra mientras el contenido está en estado de carga.",
        },
        {
            id: "loader",
            type: "boolean",
            ...
            default: "false",
            description:
                "Indica si el componente está en estado de carga, mostrando el componente loader.",
        },
        {
            id: "isPage",
            type: "boolean",
            ...
            default: "false",
            description:
                "Determina si el componente debe comportarse como una página en carga.",
        },
        {
            id: "className",
            type: "string",
