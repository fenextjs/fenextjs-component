    ...
    props: [
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el contenedor del componente ScheduleDay.",
        },
        {
            id: "defaultValue",
            ...
            description:
                "Valor inicial del campo de entrada, representado como un array de rangos de fechas.",
        },
        {
            id: "value",
            type: "ScheduleDayValueType",
            ...
            default: "undefined",
            description:
                "Valor actual del campo de entrada, usado para el control del componente desde el exterior.",
        },
        {
            id: "onChange",
            ...
            default: "N/A",
            description:
                "Función callback para manejar cambios en el valor del campo de entrada.",
        },
        {
            id: "ButtonProps",
            ...
            description:
                "Props para personalizar el botón que añade nuevos intervalos de tiempo.",
        },
        {
            id: "propsStart",
            ...
            description:
                "Props específicos para el campo de hora de inicio del rango de fecha.",
        },
        {
            id: "propsEnd",
            type: "InputDateRangeBaseProps",
            ...
            description:
                "Props específicos para el campo de hora de fin del rango de fecha.",
        },
    ],
    useExample: [
        {
