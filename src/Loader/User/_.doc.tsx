    ...
    props: [
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el contenedor del componente del usuario cargando.",
        },
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar la imagen del indicador de carga del usuario.",
        },
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el nombre del indicador de carga del usuario.",
        },
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el correo electrónico del indicador de carga del usuario.",
        },
    ],
    extras: [],
    useExample: [
