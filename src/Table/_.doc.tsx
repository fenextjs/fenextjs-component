export default {
    ...
    props: [
        ...
        },
        {
            ...
            default: '""',
            description:
                "Clase CSS para el contenedor del elemento de la tabla.",
        },
        {
            id: "classNameTable",
            type: "string",
        ...
        },
        {
            ...
            default: '""',
            description:
                "Clase CSS para las celdas del encabezado de la tabla.",
        },
        {
            id: "classNameTd",
            type: "string",
        ...
        },
        {
            ...
            default: "false",
            description:
                "Muestra un cargador mientras se cargan los datos de la tabla.",
        },
        {
            id: "typeLoader",
            type: '"spinner" | "line"',
        ...
        },
        {
            ...
            default: "true",
            description:
                "Si se deben incluir casillas de verificación en la tabla.",
        },
        {
            id: "onChecked",
            type: "(items: T[]) => void",
            require: false,
            description:
                "Función a ejecutar al seleccionar elementos de la tabla.",
        },
        {
            id: "onOrderBy",
        ...
        },
        {
            ...
            description:
                "Componente a mostrar cuando no hay resultados en la tabla.",
        },
        {
            id: "actionsCheckbox",
            ...
            require: false,
            description:
                "Propiedades para las acciones de selección múltiple de la tabla.",
        },
        {
