    ...
    props: [
        {
            ...
            default: "100",
            description:
                "El tiempo inicial en segundos que se mostrará y del cual el cronómetro comenzará la cuenta regresiva.",
        },
        {
            id: "onChange",
            ...
            default: "undefined",
            description:
                "Función que se ejecuta cada vez que el tiempo cambia, recibiendo el nuevo tiempo como parámetro.",
        },
        {
            id: "min",
            type: "number",
            ...
            default: "0",
            description:
                "El tiempo mínimo al que puede llegar el cronómetro, en segundos.",
        },
        {
