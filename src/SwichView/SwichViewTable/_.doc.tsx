export default {
    ...
    name: "SwichViewTable",
    description: "El componente SwichViewTable permite a los usuarios alternar entre diferentes vistas de tabla mediante iconos específicos para cada opción de visualización.",
    props: [
        {
            id: "className",
            type: "string",
        ...
        },
        {
            ...
            description: "Vista de tabla predeterminada que se muestra al cargar el componente.",
        },
        {
            id: "onChange",
            ...
            require: false,
            default: "undefined",
            description: "Función que se ejecuta cuando se selecciona una nueva vista de tabla.",
        }
    ],
    useExample: [
        {
