export default {
    ...
    description: "El componente SwichViewSelect permite al usuario alternar entre diferentes vistas de selección mediante opciones visuales, representadas por íconos específicos para cada vista de selección.",
    props: [
        {
            id: "className",
            type: "string",
        ...
        },
        {
            ...
            description: "Valor predeterminado de la vista de selección inicial.",
        },
        {
            id: "onChange",
            ...
            require: false,
            default: "undefined",
            description: "Función que se ejecuta al seleccionar una nueva vista.",
        }
    ],
    useExample: [
        {
