export default {
    ...
    name: "SwichViewList",
    description: "El componente SwichViewList permite al usuario alternar entre diferentes vistas o ítems mediante una lista de opciones visuales, cada una identificada por un ícono y un identificador único.",
    props: [
        {
            id: "className",
            type: "string",
        ...
        },
        {
            ...
            require: false,
            default: "undefined",
            description: "Función de cambio que se ejecuta al seleccionar una nueva opción.",
        },
        {
            id: "list",
            ...
            require: false,
            default: "[]",
            description: "Lista de ítems con íconos y identificadores únicos para cada opción.",
        },
        {
            id: "name",
            type: "string",
            ...
            description: "Nombre del grupo de opciones, útil para identificación en formularios.",
        }
    ],
    useExample: [
        {
