export default {
    ...
    props: [
        ...
        },
        {
            ...
            require: false,
            description:
                "Propiedades para la casilla de verificación que permite seleccionar o deseleccionar todos los elementos.",
        },
        {
            id: "actions",
            ...
            require: false,
            description:
                "Arreglo de funciones que toman los datos seleccionados como parámetro y devuelven un elemento React. Cada función representa una acción que se puede ejecutar en los datos seleccionados.",
        },
        {
            id: "data",
            type: "T[]",
            require: false,
            description:
                "Arreglo de datos en el que se aplicarán las acciones definidas.",
        },
    ],
    useExample: [
        {
