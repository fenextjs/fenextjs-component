export default {
    ...
    description: "Componente de selección de elementos por página para la paginación, permitiendo seleccionar el número de elementos a mostrar en cada página.",
    props: [
        {
            id: "className",
            type: "string",
            require: false,
            default: "''",
            description: "Clase CSS para el contenedor principal del componente de paginación.",
        },
        {
            id: "defaultValue",
            type: "string | number",
            require: false,
            default: "",
            description: "Valor por defecto de la opción seleccionada en el menú desplegable.",
        },
        {
            id: "listNpage",
            ...
            description: "Lista de opciones para el número de elementos por página que se puede seleccionar.",
        },
        {
            id: "onChangeNPage",
            ...
            require: false,
            default: "",
            description: "Función de callback que se llama cuando cambia la opción seleccionada en el menú desplegable.",
        }
    ],
    useExample: [
        {
