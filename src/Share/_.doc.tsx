    ...
    props: [
        {
            ...
            default: "''",
            description:
                "Clase CSS para personalizar el contenedor del componente Share.",
        },
        {
            id: "ButtonProps",
            type: "ButtonProps",
            ...
            description:
                "Props del componente Button para personalizar el botón de compartir.",
        },
        {
            id: "TitleProps",
            type: "TitleProps",
            ...
            description:
                "Props del componente Title para personalizar el título de la ventana de compartir.",
        },
        {
            id: "share",
            type: "string",
            ...
            default: "''",
            description:
                "Texto que se comparte en las redes sociales o se copia en el portapapeles.",
        },
        {
            id: "shareList",
            type: "ShareListType[]",
        ...
        },
        {
            ...
            default: "false",
            description:
                "Indica si se debe mostrar el botón de copia para compartir el texto.",
        },
    ],
    useExample: [
        {
