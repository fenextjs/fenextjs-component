...
export declare const Button: ({ className, classNameLoader, children, loader, disabled, onClick, onClickDisabled, icon, isBtn, full, size, _t, }: ButtonProps) => React.JSX.Element;
