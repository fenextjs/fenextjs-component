...
const ChatFormSendMessage = ({ useSubmitInEnter = true, btnChildren = "Send", placeholderMessage = "Message", ...props }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("form", { className: "fenext-chat-form-send-message", key: __key, onSubmit: onSubmit },
            react_1.default.createElement(Text_1.InputText, { type: "textarea", placeholder: _t(placeholderMessage), className: "fenext-chat-form-send-message-input-message", onChange: onChangeData("message"), value: data.message, onEnter: () => {
            ...
            react_1.default.createElement(Button_1.Button, { loader: loader || props?.loader, disabled: !data.message || data.message == "" }, _t(btnChildren)))));
};
