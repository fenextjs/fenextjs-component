...
const Modal = ({ classNameElementActionModalActive = "", classNameModal = {}, ElementActionModalActive, disabledElementActionModalActive = false, children, active: activeProps = undefined, onClose: onCloseProps, onActive: onActiveProps, type = "center", typeClose = "out", _t, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(Base_1.ModalBase, { ...classNameModal, onClose: onClose, active: active, type: type, _t: _t, typeClose: typeClose }, children)));
};
exports.Modal = Modal;
