...
const InputDateRange = ({ classNameInputDateRange = "", classNameInputDateRangeContentInputDate = "", classNameLabel = "", _t = (e) => e, label, min, max, defaultValue = undefined, value = undefined, onChange, propsStart = {}, propsEnd = {}, ...props }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: `fenext-input-date-range ${classNameInputDateRange}` },
            react_1.default.createElement("div", { className: `fenext-input-label ${classNameLabel}` }, (0, fenextjs_functions_1._tValidate)(label, _t)),
