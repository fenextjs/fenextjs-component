...
const ItemMenu = ({ className = "", classNameA = "", classNameIcon = "", classNameText = "", text, url, icon = react_1.default.createElement(react_1.default.Fragment, null), subItems = [], defaultActive = false, _t, }) => {
            ...
            react_1.default.createElement(Simple_1.Collapse, { defaultActive: defaultActive, header: react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(link_1.default, { href: url, legacyBehavior: true },
                        react_1.default.createElement("a", { className: `fenext-menu-item-a ${classNameA} ${router.asPath.indexOf(url) == 0
                            ...
                            react_1.default.createElement("div", { className: `fenext-menu-item-a-text ${classNameText}` }, (0, fenextjs_functions_1._tValidate)(text, _t))))) }, subItems?.map((sub, i) => (react_1.default.createElement(exports.ItemMenu, { key: i, ...sub, _t: _t })))))));
};
