...
const Img = ({ className = "", classNameImg = "", id, name = "", src, srcMin1920 = undefined, srcMin1680 = undefined, srcMin1440 = undefined, srcMin1024 = undefined, srcMin992 = undefined, srcMin768 = undefined, srcMin575 = undefined, imgIf404 = "", layers = [], onErrorImg: onErrorImg_, onClick, loader = false, _t, }) => {
    const onErrorImg = (e) => {
        const img = e.target;
        img.src = imgIf404;
        onErrorImg_?.(e);
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("picture", { className: `fenext-picture ${className} id-${id}`, onClick: onClick },
            ...
            react_1.default.createElement("img", { src: `${src}`, "data-src": `${src}`, alt: (0, fenextjs_functions_1._tValidate)(name, _t), className: `fenext-img ${classNameImg}`, onError: onErrorImg }),
