    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { ref: ref, className: `
            ...
            react_1.default.createElement("div", { className: `fenext-steps-content-btn ${classNameContentBtn} ` },
                (currentStep != 0 || forceShowBtnPrev) && (react_1.default.createElement(Button_1.Button, { className: `fenext-steps-btn fenext-steps-btn-prev ${classNameBtn} ${classNameBtnPrev}`, disabled: disabledBtnPrev, onClick: onPrev_, loader: loader, _t: _t }, btnPrev)),
                ...
                (currentStep != items.length - 1 || forceShowBtnNext) && (react_1.default.createElement(Button_1.Button, { className: `fenext-steps-btn fenext-steps-btn-next ${classNameBtn} ${classNameBtnNext}`, disabled: disabledBtnNext, onClick: onNext_, loader: loader, _t: _t }, btnNext))))));
};
exports.Steps = Steps;
