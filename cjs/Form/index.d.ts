...
export declare const Form: <D = any, R = any, E = any>({ id, data, disabled, onChangeDisable, onChangeLoader, children, yup, validateAfterYup, className, ...props }: PropsWithChildren<FormProps<D, R, E>>) => React.JSX.Element;
