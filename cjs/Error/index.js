...
const ErrorComponent = ({ error, children, className = "", useDataError = true, _t, }) => {
    ...
    return (react_1.default.createElement("div", { className: `fenext-error ${className} fenext-error-${error?.code}`, "data-error": useDataError ? error?.data : undefined }, content));
};
