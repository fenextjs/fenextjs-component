...
const LayoutGridMenuTopLeft = ({ className = "", classNameLoader = "", classNameChildren = "", classNameMenuTop = "", classNameMenuLeft = "", classNameMenuLeftContent = "", children, menuLeft, menuTop, loader = false, menuLeftActive = true, menuLeftMovilActive = false, useHeaderButtonMenu = false, usePageProgress = true, }) => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(GridMenuTop_1.LayoutGridMenuTop, { className: `fenext-layout-grid fenext-layout-grid-mtl ${className}`, classNameMenuTop: classNameMenuTop, menuTop: menuTop, usePageProgress: false },
            react_1.default.createElement(GridMenuLeft_1.LayoutGridMenuLeft, { classNameLoader: classNameLoader, classNameChildren: classNameChildren, classNameMenuLeft: classNameMenuLeft, classNameMenuLeftContent: classNameMenuLeftContent, menuLeft: menuLeft, loader: loader, menuLeftActive: menuLeftActive, menuLeftMovilActive: menuLeftMovilActive, useHeaderButtonMenu: useHeaderButtonMenu, usePageProgress: usePageProgress }, children))));
};
