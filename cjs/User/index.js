...
const User = ({ className = "", classNameEmail = "", classNamePicture = "", classNameImg = "", classNameName = "", classNameLoader = {}, user, loader = false, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: `fenext-user ${className} ` },
            react_1.default.createElement(Img_1.Img, { ...user?.img, src: user?.img?.src ?? fenextjs_img_placeholder_1.FenextImgUserPlaceholder, className: `fenext-user-picture ${classNamePicture}`, classNameImg: `fenext-user-img ${classNameImg}`, imgIf404: fenextjs_img_placeholder_1.FenextImgUserPlaceholder }),
